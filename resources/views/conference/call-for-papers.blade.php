            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="max-w-3xl mx-auto text-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a href="/templates/GETS-Abstract%20Submission-Guideline-2026.docx" download="GETS-Abstract Submission-Guideline-2026.docx" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-forest text-white font-display font-semibold rounded-lg hover:bg-forest-700 transition-all duration-300 shadow-md hover:shadow-lg">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                            </svg>
                            <span>Abstract Template (.DOCX)</span>
                        </a>

                        {{-- Secondary: Download PDF --}}
                        <a href="/templates/GETS-Abstract%20Submission-Guideline-2026.pdf" download="GETS-Abstract Submission-Guideline-2026.pdf" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-forest font-display font-semibold rounded-lg border-2 border-forest hover:bg-forest/5 transition-all duration-300">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                            </svg>
                            <span>Abstract Template (.PDF)</span>
                        </a>
                    </div>
                </div>
            </div>
