        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-200 hover:border-forest/30 transition-colors flex flex-col">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="/templates/GETS2026_Oral_Presentation_Template.pptx" download="GETS2026_Oral_Presentation_Template.pptx" class="inline-flex items-center gap-1.5 px-4 py-2 bg-forest text-white text-sm font-medium rounded-lg hover:bg-sage transition-colors">
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-200 hover:border-forest/30 transition-colors flex flex-col">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="/templates/GETS2026_Digital_Poster_Template.pptx" download="GETS2026_Digital_Poster_Template.pptx" class="inline-flex items-center gap-1.5 px-4 py-2 bg-forest text-white text-sm font-medium rounded-lg hover:bg-sage transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                        </svg>
                        <span>Download</span>
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-200 hover:border-forest/30 transition-colors flex flex-col">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="/templates/GETS2026_Virtual_Background.zip" download="GETS2026_Virtual_Background.zip" class="inline-flex items-center gap-1.5 px-4 py-2 bg-forest text-white text-sm font-medium rounded-lg hover:bg-sage transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                        </svg>
                        <span>Download</span>
