...
>
    ...
    {{-- Photo --}}
    @if ($speaker['photo'])
        <div class="w-14 h-14 rounded-xl bg-orange-50 ring-2 ring-orange-100 overflow-hidden flex-shrink-0">
            <img
    ...
    @else
        <div class="w-14 h-14 rounded-xl bg-orange-50 border border-orange-200
